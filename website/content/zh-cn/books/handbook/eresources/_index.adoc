...
The most important points of contact are outlined below. The link:https://wiki.freebsd.org/Community[Community wiki area] may be more up-to-date.
...
[NOTE]
====
To test FreeBSD mailing list capabilities, aim for the {freebsd-test}. Please do not send test messages to any other list.
====
