...
<.> The username used to authenticate with your ISP. <.> The password used to authenticate with your ISP.
...
<.> The IP address of FreeBSD computer running mpd. <.> The IP address of the ADSL modem. The Alcatel SpeedTouch(TM) Home defaults to `10.0.0.138`.
